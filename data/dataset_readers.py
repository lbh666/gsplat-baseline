...
from utils.colmap_parsing_utils import read_extrinsics_text, read_intrinsics_text, qvec2rotmat, \
...
from utils.tensor_dataclass import BasicPointCloud
from utils.utils import camera_nerfies_from_JSON
...
def load_K_Rt_from_P(filename: str, P=None):
    if P is None:
